...
- **No blog, articles, or personal-life content** — not what the ten-second scan needs; deferred to v2. Section composition stays open so it is additive later, but nothing is built now.
